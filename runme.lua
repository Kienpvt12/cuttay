...
getgenv().gagConfig = {
    ...
    KEEP_PETS = { "Tanuki", "Ostrich", "Capybara", ["Koi"] = 2, "Tanchozuru", "Seal", "Kitsune", "Kappa" , "Bald Eagle", "Fennec Fox", "Blood Kiwi", "Peacock", "Rooster", ["Hamster"] = 2, "Disco Bee", "Raccoon", "Queen Bee", "Dragonfly", "Butterfly", "Mimic Octopus", "Red Fox", "Chicken Zombie", ["Nihonzaru"] = 2 },
    KEEP_PETS_WEIGHT = 10,
